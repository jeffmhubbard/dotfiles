...
let s:cursor_line_grey = s:colors.cursor_line_grey
...
call s:h("Function", { "fg": s:purple }) " function name (also: methods for classes)
...
call s:h("markdownLinkText", { "fg": s:purple })
